      ...
      {id !== null ? (
          ...
          <div className="w-3/4">
            <div className="font-bold flex items-center space-x-4 pt-2 pb-2 text-customDefaultText text-2xl w-full border-b-2">
              ...
              <div
                ...
                onClick={() => router.push("/discovery/category")}
              >
                Category
              </div>
              <div
                className="cursor-pointer"
                onClick={() => router.push("/discovery/category?id=" + id)}
              >
              ...
              {id_group !== null ? (
                <div
                  ...
                  onClick={() =>
                    router.push(
                      "/discovery/category?id=" + id + "&id_group=" + id_group
                    )
                  }
                >
            ...
            {id_group !== null ? (
              <div className="mt-4">
                <BookGroupDetail
                  data={dataBookGroupDetail}
                  category={groupBook[id_group - 1].name}
                />
              </div>
            ) : (
              <div className="mt-4">
        ...
        <div className="w-full">
          <div className="font-bold flex items-center space-x-4 pt-2 pb-2 text-customDefaultText text-2xl w-full border-b-2">
            ...
            {id !== null && <div>{"> " + dataCategory[id].name}</div>}
          </div>
        </div>
      )}
