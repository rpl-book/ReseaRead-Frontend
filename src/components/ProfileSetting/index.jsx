      ...
      <div className="flex text-[20px] w-full h-[12%]">
        {label.map((dt, index) => (
          <button
            className={
              index === 0
                ? "w-full px-10 py-5 hover:bg-customGrayButton hover:text-white text-customDefaultText rounded-tl-xl " +
                  (activeButton === dt ? " bg-customGrayButton text-white" : "")
                : index === label.length - 1
                ? "w-full px-10 py-5 hover:bg-customGrayButton hover:text-white text-customDefaultText rounded-tr-xl " +
                  (activeButton === dt ? " bg-customGrayButton text-white" : "")
                : "w-full px-10 py-5 hover:bg-customGrayButton hover:text-white text-customDefaultText" +
                  (activeButton === dt ? " bg-customGrayButton text-white" : "")
            }
            onClick={() => {
              setActiveButton(dt);
          ...
          <div className="w-3/4 pt-16">
            <form action="#">
              <div className="grid grid-cols-2 text-customDefaultText">
                ...
                {/* {data.name} */}
                {/* </div> */}
                <div className="pt-4 pb-4">Date of Birth</div>
                ...
                <div className="pt-4 pb-4">Gender</div>
                ...
                {/* {data.gender} */}
                {/* </div> */}
                <div className="pt-4 pb-4">Email</div>
                <input
                  className="pt-4 pb-4"
                  value={email}
                  type="text"
            ...
            <div className="grid grid-cols-2 text-customDefaultText">
              <div className="pt-4 pb-4">Username</div>
              <input
                className="pt-4 pb-4"
                value={username}
                type="text"
              ...
              />
              <div className="pt-4 pb-4">Password</div>
              <input
                type="password"
                className="pt-4 pb-4"
                value={password}
