...
import "./TableRow.css"; 
import ModalDeleteBook from '../../app/modal-deletebook/page'; 
import ModalEditBook from '../../app/modal-editbook/page'; 

const NewTableRow = ({ cover, bookTitle, bookAuthor, dateAdded, readingStatus, currentPage, totalPage }) => {
    ...
    <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
      ...
      <td className="px-5 py-3 text-center text-end text-m font-medium">
        <div className="configure">
          <button type="button" className="inline-flex items-center gap-x-2"  onClick={openModalDelete}><AiOutlineDelete /></button>
          <button type="button" className="inline-flex items-center gap-x-2 ml-5"  onClick={openModalEdit}><GoPencil /></button>
        </div>
      </td>
      
      {isModalDeleteOpen && <ModalDeleteBook closeModalDelete={closeModalDelete} />}
